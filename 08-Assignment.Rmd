...
```{r, echo = FALSE}
vembedr::embed_youtube("1pK88G_WHD0", height = 400)
```
...
**5:** Maker characters to numeric. Replace `XXX` with the appropriate function to convert all columns apart from time from character to numbers. See Recipe \@ref(WRANGLE-CHARACTER-2-NUMERIC).
