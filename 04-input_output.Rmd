...
fms <- read.xlsx ("data\groupFMS.xlsx")
```
...
fms <-  read.xlsx (xlsxFile = "data/groupFMS.xlsx",
                    sheet = "FMS")
...
downloadthis::download_file(
  path = "data/groupFMS.xlsx",
  output_name = "groupFMS",
...
4. Import the Excel file `data/groupFMS.xlsx` and assign it to an object `dat_fms`. See  Recipe \@ref(INPUT-IMPORT). Remember to add some comments to remind yourself what this line of code is trying to do. **Save it**.

5. Import the Excel file `data/rightleg_imu.xlsx` and assign it to an object `bad_leg_accl`. See  Recipe \@ref(INPUT-IMPORT). Remember to add some comments to remind yourself what this line of code is trying to do. **Save it**.

6. Import the Excel file `data/leftleg_imu.xlsx` and assign it to an object `good_leg_accl`. See  Recipe \@ref(INPUT-IMPORT). Remember to add some comments to remind yourself what this line of code is trying to do. **Save it**.
