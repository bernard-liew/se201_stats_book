...
```{r, echo=FALSE}
htmltools::img(src = knitr::image_uri(file.path("HPU_logo.jpg")), 
               alt = 'logo', 
...
**Athlete's height (cm): **`r dat$demog$height`

**Athlete's weight (kg): **`r dat$demog$weight`
