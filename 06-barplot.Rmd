...
```{r, echo = FALSE}
vembedr::embed_youtube("SszyupgnpPE", height = 400)
```
...
```{r, echo = FALSE}
vembedr::embed_youtube("DvftSrrRKBI", height = 400)
```
...
```{r, echo = FALSE}
vembedr::embed_youtube("Oy--0wk6bAI", height = 400)
```
...
```{r, echo = FALSE}
vembedr::embed_youtube("-2SGjMrcAFsY", height = 400)
```
