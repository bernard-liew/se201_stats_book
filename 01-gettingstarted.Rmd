...
R and RStudio have been around for several years -- however, they are *constantly* being updated with new features and bug-fixes. At the time that I am writing this sentence ("`r Sys.Date()`"), the latest version of Base-R is 4.2.1, and the latest version of RStudio is 2022.07.1.
...
```{r, echo = FALSE}
vembedr::embed_url("https://youtu.be/2_n6y2Ch6Fs")
```
...
```{r, echo = FALSE}
vembedr::embed_url("https://youtu.be/Zu3Elwuqkhc")
```
...
```{r, echo = FALSE}
vembedr::embed_url("https://www.youtube.com/watch?v=KCB_cp8UHU4&list=PLLsXsBAdxWDYXLhdu3HiVlHZK61LViAk9&index=5&t=2s")
```
