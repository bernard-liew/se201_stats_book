...
7. Close RStudio, reopen RStudio via the `.Rproj` symbol Figure \@ref(fig:launching). In the Files tab on the bottom right, you should see the script you created `practice_script.R`. Click on it to open and you should see the code you typed. Try to run the codes you typed, what answer did you get?
