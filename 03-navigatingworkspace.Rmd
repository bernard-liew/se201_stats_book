...
```{r, echo = FALSE}
vembedr::embed_youtube("gjgXcUzpyzU", height = 400)
```
...
```{r, echo = FALSE}
vembedr::embed_youtube("f6yTQopoyOg", height = 400)
```
...
```{r installfromsource, fig.cap= "Click No when you see this prompt.", fig.margin = TRUE, fig.align = 'center', echo = FALSE, out.width = "75%"}
knitr::include_graphics(c("images/chapter-3/binary.png"))
```

```{r installfromsourceagain, fig.cap= "Click No when you see this prompt again.", fig.margin = TRUE, fig.align = 'center', echo = FALSE, out.width = "75%"}
knitr::include_graphics(c("images/chapter-3/install_source.png"))
```
...
```{r, echo = FALSE}
vembedr::embed_youtube("JYJjXaKrvK4", height = 400)
```
...
downloadthis::download_file(
  path = "data/practice_navig.R",
  output_name = "Learning check 4 answers",
  output_extension = ".R",
  button_label = "Learning check 4 answers",
  button_type = "warning",
  has_icon = TRUE,
  icon = "fa fa-save"
