...
4. Using the data `dat_summ`, keep the interval of 2:30 to 3:00min of data at each stage of VO2 testing. See Recipe \@ref(WRANGLE-SUMMARIZE-GROUPBY).

5. From step 5, find the mean of each 30s of data of each stage, across all variables. See Recipe \@ref(WRANGLE-SUMMARIZE-GROUPBY).

6. Make a line plot with with `vo2` as the *x* axis, and `vo2` as the *y* axis. See Recipe \@ref(LINE-GRAPH-BASIC-LINE).
