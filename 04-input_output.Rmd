...
```{r, echo = FALSE}
vembedr::embed_url("https://youtu.be/ZK-oVC0-5NA")
```
...
```{r, echo = FALSE}
vembedr::embed_url("https://youtu.be/oZ6yoZ_86BY")
```
...
```{r, echo = FALSE}
vembedr::embed_url("https://youtu.be/cvI7LyODZ14")
```
...
```{r echo=FALSE}
downloadthis::download_file(
  path = "data/simFMS.xlsx",
  output_name = "group_fms",
  output_extension = ".xlsx",
  button_label = "Group FMS data",
  button_type = "warning",
  has_icon = TRUE,
  icon = "fa fa-save"
