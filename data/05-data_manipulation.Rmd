...
```{r, echo = FALSE}
vembedr::embed_url("https://youtu.be/XVTX1L9iZIo")
```
...
```{r, echo = FALSE}
vembedr::embed_url("https://youtu.be/utuxfSl1umU")
```
...
```{r, echo = FALSE}
vembedr::embed_url("https://youtu.be/duTAu0314og")
```
...
```{r, echo = FALSE}
vembedr::embed_url("https://youtu.be/B8WN5PzQRdk")
```
...
```{r, echo = FALSE}
vembedr::embed_url("https://youtu.be/nyDBN0norho")
```
...
```{r, echo = FALSE}
vembedr::embed_url("https://youtu.be/-xKvvvsYAXw")
```
...
```{r, echo = FALSE}
vembedr::embed_url("https://youtu.be/997159RN4Qg")
```
...
```{r, echo = FALSE}
vembedr::embed_url("https://youtu.be/WzWUvmZ0JQU")
```
...
```{r, echo = FALSE}
vembedr::embed_url("https://youtu.be/g0Rrmur31MU")
```
### Problem
...
```{r, echo = FALSE}
vembedr::embed_url("https://youtu.be/D0a18-ge5tE")
```
