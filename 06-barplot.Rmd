...
We give these specifications separated by a comma. Note that `" "` are not required when giving variables within aes().
...
Given we want a bar plot, we need to specify that the geometric representation of the data will be in point form, using `geom_col()`.
